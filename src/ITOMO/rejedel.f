...
c TYPE definitions ++++++++++++++++++++++++++++++++++++++
      ...
      real*4    pe_re(16),c_re(16),am_re(20)
      real*4    delta,dum,dum1,phv_re
      integer*4 i,j
c END TYPE definitions ++++++++++++++++++++++++++++++++++
      data pe_re/10.,20.,40.,60.,80.,100.,125.,150.,175.,200.,225.,
     +250.,275.,300.,350.,400./
      data c_re/3.05,3.42,3.875,4.00,4.06,4.115,4.19,4.29,4.40,4.53,
     +4.69,4.89,5.05,5.24,5.585,5.88/
      dpi=4.0d0*DATAN(1.0d0)
      drad=dpi/180.d0
C------- Rejection ----------------------------------------------
      CALL SPLINE(16,pe_re,c_re,am_re,2,0.,2,0.)
      CALL SPLDER(1,16,pe_re,c_re,am_re,Tper,phv_re,dum,dum1,*993)
c**      write (*,*) Tper,phv_re
C------- Rejection ----------------------------------------------
      j=0
      do i=1,n
