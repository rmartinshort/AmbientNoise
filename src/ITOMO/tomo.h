...
C-----NRAZ--dimension of the main matrix;
...
C-----------------------COMMON /name/--------------------------------
      character*160 fname1,fname2,fname3,fname4,root
      common/name/  fname1,fname2,fname3,fname4,root
C********************************************************************
