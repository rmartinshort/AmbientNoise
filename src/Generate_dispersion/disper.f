...
c-----
      ...
      real*4 din(1),ain(1),bin(1),rhoin(1)
...
c	write(LOT,*)'Get present model using OPTION 28, edit obs.d,'
...
c----------------------------
 2222	continue
	print*, 'pas de calcule de vitesse de phase'
	STOP 
c----------------------------
								END
c///////////////////////////////////////////////////////////////////////////
