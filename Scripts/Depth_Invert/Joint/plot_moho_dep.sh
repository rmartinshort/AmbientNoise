...
$GMT surface Moho_depth.dat -R200/224/58/70 -I0.2 -T0.1 -GMoho_dep.grd
GRD=Moho_dep.grd

$GMT makecpt -Crainbow -T10/60/1 -Z > mohodep.cpt
cpt=mohodep.cpt
...
#plot the coastlines
$GMT pscoast -R$R -J$J -Ba8.0f2.0/a4.0f2.0 -Wthinnest -A500 -Di -P -K -O  >> $ps
...
#Plot the stations
#$GMT psxy $stations -J$J -Rd$R -Si0.2 -Gblack -O -K -Wthinnest,black >> $ps
