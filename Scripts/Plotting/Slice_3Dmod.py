...
def depthsliceGMT(df,sliceinc=5):
    ...
    for depth in dvals:
        ...
        if (depth%sliceinc == 0):
            ...
            dslice_pert = mask_data(dslice_pert,'pert')
            ...
            os.system('gmt xyz2grd %s -G%s -I0.2 -R189/237/56.0/73.0' %(slicename,grdname))
            os.system('gmt xyz2grd %s -G%s -I0.2 -R189/237/56.0/73.0' %(slicename_pert,grdname_pert))
